...
import { listDocuments, updateDocument, deleteDocument, type Document } from '@/lib/api';

// Note: We don't have getDocumentById in API yet, only getDocument (by slug).
// ... (comments)
...
export default function EditDocPage() {
    ...
    useEffect(() => {
        const load = async () => {
            try {
                // TODO: Replace with real getById API
                const docs = await listDocuments(false);
