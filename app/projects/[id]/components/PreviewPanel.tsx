...
export function PreviewPanel({
    ...
    return (
        <div className="flex flex-col w-full h-full relative bg-zinc-50/50 dark:bg-zinc-900/50 backdrop-blur-sm">
            ...
            {/* Header */}
            <div className="px-5 py-3 border-b border-zinc-200/60 dark:border-zinc-800/60 flex items-center justify-between gap-3 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl sticky top-0 z-20 supports-[backdrop-filter]:bg-white/60 flex-wrap">
